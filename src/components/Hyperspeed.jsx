...
class App {
  constructor(container, options = {}) {
    ...
    const initW = Math.max(1, container.offsetWidth || 300);
    const initH = Math.max(1, container.offsetHeight || 300);
...
export default function Hyperspeed({ effectOptions = DEFAULT_EFFECT_OPTIONS, className = '', style = {} }) {
  ...
  return (
    <div className={`hyperspeed-container ${className}`} ref={hyperspeed} style={style}>
